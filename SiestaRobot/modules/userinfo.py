...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + "╘══「 Powered By [ichigo](https://t.me/ichigoxsinbot) | [Network](https://t.me/aboutastaXbonten) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + f"\n\n✦ [Support](https://t.me/ichigosupportchat) | ✦ [Updates](http://t.me/ichigosupportchat)\n\n"
                )
                + "╘══「 Powered By [ichigo](https://t.me/ichigoxsinbot) | [Network](http://t.me/aboutastaXbonten)」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
