...
def get_user_list(__init__, key):
    with open("{}/IchigoRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[IchigoRobot] %(message)s"
logging.basicConfig(
...
LOGGER.info("Project maintained by: github.com/shiinobu (t.me/Husbandoo)")
...
DRAGONS.add(193891135)
DRAGONS.add(5102580882)
DRAGONS.add(1802324609)
DRAGONS.add(5293428505)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(1938491135)
DEV_USERS.add(5293428505)
