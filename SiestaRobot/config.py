...
def get_user_list(config, key):
    with open("{}/IchigoRobot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "baby_hoii"
    SUPPORT_CHAT = "ichigosupportchat"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001180007354
